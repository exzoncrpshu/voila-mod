...
const sunucuAyar = require("../exzsettings/sunucuAyar.js");
...
module.exports.execute = async(client, message, args,ayar,emoji) => {
   // if(!message.member.roles.cache.array().some(rol => message.guild.roles.cache.get(ayar.staffrole).rawPosition <= rol.rawPosition)) return  message.reply("`Bu komut yetkililere özeldir.`");
    ...
    const top = new MessageEmbed().setColor(client.randomColor()).setAuthor(kullanici.tag.replace('`', ''), kullanici.avatarURL({dynamic: true, size: 2048}));
 ...
 /*       if(data.totalVoiceStats >= 1080000000) { 
          uye.roles.remove(sunucuAyar.voice1)
          uye.roles.remove(sunucuAyar.voice2)
          uye.roles.remove(sunucuAyar.voice3)
          uye.roles.remove(sunucuAyar.voice4)
          uye.roles.remove(sunucuAyar.voice5)
          uye.roles.add(sunucuAyar.voice6) 
        } else if(data.totalVoiceStats >= 630000000) {
          uye.roles.remove(sunucuAyar.voice1)
          uye.roles.remove(sunucuAyar.voice2)
          uye.roles.remove(sunucuAyar.voice3)
          uye.roles.remove(sunucuAyar.voice4)
          uye.roles.add(sunucuAyar.voice5)
          uye.roles.remove(sunucuAyar.voice6) 
        } else if(data.totalVoiceStats >= 360000000) {
          uye.roles.remove(sunucuAyar.voice1)
          uye.roles.remove(sunucuAyar.voice2)
          uye.roles.remove(sunucuAyar.voice3)
          uye.roles.add(sunucuAyar.voice4)
          uye.roles.remove(sunucuAyar.voice5)
          uye.roles.remove(sunucuAyar.voice6) 
        } else if(data.totalVoiceStats >= 270000000) {
          uye.roles.remove(sunucuAyar.voice1)
          uye.roles.remove(sunucuAyar.voice2)
          uye.roles.add(sunucuAyar.voice3)
          uye.roles.remove(sunucuAyar.voice4)
          uye.roles.remove(sunucuAyar.voice5)
          uye.roles.remove(sunucuAyar.voice6) 
        } else if(data.totalVoiceStats >= 180000000) {
          uye.roles.remove(sunucuAyar.voice1)
          uye.roles.add(sunucuAyar.voice2)
          uye.roles.remove(sunucuAyar.voice3)
          uye.roles.remove(sunucuAyar.voice4)
          uye.roles.remove(sunucuAyar.voice5)
          uye.roles.remove(sunucuAyar.voice6) 
        } else if(data.totalVoiceStats >= 90000000) {
          uye.roles.add(sunucuAyar.voice1)
          uye.roles.remove(sunucuAyar.voice2)
          uye.roles.remove(sunucuAyar.voice3)
          uye.roles.remove(sunucuAyar.voice4)
          uye.roles.remove(sunucuAyar.voice5)
...
module.exports.configuration = {
    name: 'totalstats',
    aliases: ['totalstat', 'topstat', 'topstats'],
    usage: 'totalstats/top [üye]',
